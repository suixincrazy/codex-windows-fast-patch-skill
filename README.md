...
- `scripts/patch-computer-use-helper-win10.ps1`：为精确支持哈希的 `@oai/sky 0.4.20`、`0.5.2` 和 `0.6.6` helper 提供只读识别、安装和回滚；`26.707.12708.0`、`26.721.4979.0` 与 `26.803.10989.0` 是各自的端到端验证基线，不是版本门槛。
